...
import { FileText, Maximize2, X, FileImage, Loader2, Table, Presentation, FileSpreadsheet } from "lucide-react";
          ...
          {isPptx && (
            ...
            >
              ...
              <div className="flex justify-between items-center text-[10px] text-slate-400 pt-2 border-t border-slate-800">
                <span>{file.orientation} Slide</span>
                <span className="text-amber-400 font-bold group-hover:underline">Tap for Full Preview</span>
              </div>
            </div>
          )}
          ...
          {isExcel && !isText && (
            ...
            >
              ...
              <div className="text-[10px] text-emerald-700 font-bold text-center group-hover:underline">
                Tap to inspect full spreadsheet pages
              </div>
            </div>
          )}
          ...
          {isDocx && (
            ...
            >
              ...
              <div className="text-[10px] text-blue-600 font-bold text-center pt-2 border-t border-slate-100 group-hover:underline">
                {file.pageCount} Pages · Tap to preview
              </div>
            </div>
          )}
        ...
        <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-md flex flex-col p-4">
          ...
          <div className="flex-1 flex items-center justify-center overflow-auto p-2">
            {isImage ? (
              ...
              <div className="bg-white p-8 rounded-card max-w-md w-full text-center shadow-2xl">
                ...
                <p className="text-xs font-semibold text-emerald-600 mt-4 bg-emerald-50 py-2 rounded">
                  Document ready for physical kiosk printing
                </p>
              </div>
            )}
          </div>
